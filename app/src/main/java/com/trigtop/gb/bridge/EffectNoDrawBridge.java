...
import com.trigtop.gb.util.SDKVersionUtils;
import com.trigtop.gb.widget.OpenEffectBridge;
    ...
    public void flyWhiteBorder(final View focusView, View moveView, float scaleX, float scaleY) {
        ...
        mAnimatorSet.addListener(new AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                // BUG:5.0系统边框错位.
                if (SDKVersionUtils.getSDKVersion() >= 21) {
