...
//        LogUtil.d("-------Util.copyDatabaseFromAssert() start");
        try {
            ...
            //LogUtil.i("-------Util.copyDatabaseFromAssert() error:" + e.toString());
        }
        //       LogUtil.i("-------Util.copyDatabaseFromAssert() completed");
    }

    public static void copyWallpaperFromAssert(final Context context) {
//        LogUtil.i("-------Util.copyWallpaperFromAssert() start");
        try {
...
//        try {
//            //获取volumeInfo
//            List<Object> volumeInfos = (List<Object>) sm.getClass().getMethod("getVolumes", (Class<?>) null).invoke(sm, (Object) null);
//            LogUtil.d("usb", "start");
//            for (final Object info : volumeInfos) {
//                LogUtil.d("usb", "type is : " + info.getClass().getMethod("getType", (Class<?>) null).invoke(info, (Object) null));
//                //获取设备状态
//                if ((Integer) info.getClass().getMethod("getType", (Class<?>) null).invoke(info, (Object) null) == 0
//                        && (Integer) info.getClass().getMethod("getState", (Class<?>) null).invoke(info, (Object) null) == 2) {
...
//                    map.put(name, id);
//                } else {
//                    LogUtil.d("usb", "Skipping volume " + info.toString());
//                }
//            }
//        } catch (Exception e) {
//            e.printStackTrace();
//            LogUtil.d("usbor during Sync: 您的主机中的软件中止了一个已建立的连接。\n" +
