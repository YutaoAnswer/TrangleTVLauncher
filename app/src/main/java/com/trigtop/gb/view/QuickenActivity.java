...
import com.trigtop.gb.model.TaskInfo;
import com.trigtop.gb.model.TaskInfoProvider;
import com.trigtop.gb.util.Tools;
import com.trigtop.gb.widget.WaveLoadingView;
 ...
 * 加速
 */
public class QuickenActivity extends AppCompatActivity {
        ...
        public boolean handleMessage(Message msg) {
            switch(msg.what){
                ...
                case CLEAR_FINISH:
                    ...
                    Tools.showLongToast(QuickenActivity.this , "为您腾出 "+floatStrToInt(clearmemory)+"M 空间");
    ...
    class QuickenTask implements Runnable{
        ...
        public void run() {
            ...
            if(stopThread){
                ...
                getRunningApp();
                TaskInfoProvider taskInfoProvider = new TaskInfoProvider(QuickenActivity.this);
